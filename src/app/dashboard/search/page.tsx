...
import { Search as SearchIcon, SlidersHorizontal, Loader2, ChevronDown, X, Filter } from "lucide-react";
...
export default function SearchPage() {
    ...
    const {
        ...
        manglik: filters.manglik === 'yes' ? true : filters.manglik === 'no' ? false : undefined,
    ...
    const profiles = allProfiles.filter(p => p?.id && !hiddenIds.has(p.id));
