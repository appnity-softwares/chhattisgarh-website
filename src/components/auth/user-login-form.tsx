            ...
            >
                ...
                <div className="flex flex-col items-center mb-10 space-y-3">
                    ...
                    <h2 className="text-3xl font-bold tracking-tight text-foreground uppercase">
                        {otpSent ? "Verify" : "Login"} <span className="text-primary font-medium">Securely</span>
                    </h2>
                ...
                <Card className="glass-card rounded-[2.5rem] border-white/10 shadow-3xl overflow-hidden relative">
                            ...
                            {!otpSent ? (
                                ...
                                >
                                    <div className="space-y-3">
                                        ...
                                        <div className="relative group">
                                            ...
                                            <Input 
                                                ...
                                                className="pl-24 h-16 bg-white/5 border-white/10 rounded-2xl focus:ring-primary/20 font-bold text-lg tracking-[0.2em] transition-all group-hover:border-primary/40 focus:bg-white/10"
                                            />
                                        </div>
                                    </div>
                                    ...
                                    <Button 
                                        ...
                                        className="w-full h-16 bg-primary hover:bg-primary/90 text-white font-bold text-lg rounded-2xl shadow-xl shadow-primary/20 active:scale-95 transition-all group"
                                    >
                                        SEND OTP
                                    ...
                                    <div className="flex flex-col items-center space-y-4 pt-4">
                                        <Link href="/register" className="text-xs font-bold uppercase tracking-widest text-muted-foreground hover:text-primary transition-colors">
                                    ...
                                    <div className="space-y-6 text-center">
                                        <div className="flex justify-center gap-3">
                                            <Input 
                                                ...
                                                className="w-full h-20 text-center text-4xl font-bold tracking-[0.4em] bg-white/5 border-white/10 rounded-2xl focus:ring-primary/20 text-primary"
                                            />
                                        </div>
                    ...
                    <div className="bg-white/5 p-6 border-t border-white/5 flex items-center justify-center gap-3">
                        ...
                        <span className="text-[10px] font-bold uppercase tracking-[0.2em] text-muted-foreground">Firebase Secured Auth</span>
                    </div>
                </Card>

                {/* Decorative Bottom Link */}
                <div className="mt-10 flex justify-center gap-6">
                    <Link href="/faq" className="text-[9px] font-bold uppercase tracking-widest text-muted-foreground hover:text-foreground transition-colors">Help</Link>
                    <div className="w-1 h-1 bg-white/10 rounded-full my-auto" />
                    <Link href="/terms" className="text-[9px] font-bold uppercase tracking-widest text-muted-foreground hover:text-foreground transition-colors">Terms</Link>
                    <div className="w-1 h-1 bg-white/10 rounded-full my-auto" />
                    <Link href="/privacy" className="text-[9px] font-bold uppercase tracking-widest text-muted-foreground hover:text-foreground transition-colors">Privacy</Link>
                </div>
            </motion.div>
        </div>
    );
