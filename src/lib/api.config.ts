...
export const apiConfig = {
  ...
  endpoints: {
    ...
    admin: {
      ...
      contactRequest: (id: string | number) => `/admin/contact-requests/${id}`,
      photoRequests: '/admin/photo-requests',
      photoRequest: (id: string | number) => `/admin/photo-requests/${id}`,
      agentUsers: (id: string) => `/admin/agents/${id}/users`,
      chats: '/admin/chats',
      chat: (id: string | number) => `/admin/chats/${id}`,
      chatMessage: (id: string | number) => `/admin/chats/messages/${id}`,
      bulkModeration: '/admin/moderation/bulk',
