    ...
    return (
        <div className="space-y-8 pb-20">
            ...
            <div className="space-y-2 px-1">
                <h1 className="text-3xl md:text-4xl font-bold tracking-tight uppercase text-foreground">App <span className="text-primary font-medium">Settings</span></h1>
                <p className="text-muted-foreground font-light text-lg">Manage your account preferences and privacy controls</p>
            </div>
            <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
                <div className="flex border-b border-border pb-0 mb-8 overflow-x-auto no-scrollbar">
                    <TabsList className="bg-transparent border-none p-0 h-auto gap-10">
                        <TabsTrigger 
                            value="privacy" 
                            className="bg-transparent border-none p-0 pb-4 text-sm font-bold uppercase tracking-[0.2em] text-muted-foreground data-[state=active]:text-primary data-[state=active]:border-b-4 data-[state=active]:border-primary rounded-none transition-all flex items-center gap-2"
                        >
                ...
                <TabsContent value="privacy" className="space-y-8">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <CardContent className="p-8 space-y-8">
                                <div className="flex items-center justify-between">
                                    <div className="space-y-1">
                                        <h4 className="font-bold text-sm uppercase tracking-widest text-foreground">Profile Visibility</h4>
                                ...
                                <div className="flex items-center justify-between">
                                    <div className="space-y-1">
                                        <h4 className="font-bold text-sm uppercase tracking-widest text-foreground">Photo Settings</h4>
                        ...
                        <Card className="bg-surface backdrop-blur-3xl border-border rounded-[2rem] overflow-hidden">
                            <CardContent className="p-8 space-y-8">
                                <div className="flex items-center justify-between">
                                    <div className="space-y-1">
                                        <h4 className="font-bold text-sm uppercase tracking-widest text-foreground">Contact Privacy</h4>
                                ...
                                <div className="flex items-center justify-between">
                                    <div className="space-y-1">
                                        <h4 className="font-bold text-sm uppercase tracking-widest text-foreground">Visit Log</h4>
                    ...
                    <div className="bg-primary/5 border border-primary/20 p-6 rounded-[2rem] flex items-center gap-4 mx-2">
                        ...
                        <div>
                            <p className="font-bold text-sm uppercase tracking-widest text-foreground">Your data is encrypted</p>
                ...
                <TabsContent value="notifications" className="space-y-8">
                    <Card className="bg-surface backdrop-blur-3xl border-border rounded-[2.5rem] overflow-hidden max-w-2xl">
                        <CardContent className="p-10 space-y-10">
                            <div className="flex items-center gap-6">
                                ...
                                <div className="flex-1 space-y-1">
                                    <h4 className="font-bold text-sm uppercase tracking-widest text-foreground">WhatsApp Alerts</h4>
                            ...
                            <div className="flex items-center gap-6">
                                ...
                                <div className="flex-1 space-y-1">
                                    <h4 className="font-bold text-sm uppercase tracking-widest text-foreground">Desktop Push</h4>
                            ...
                            <div className="flex items-center gap-6">
                                ...
                                <div className="flex-1 space-y-1">
                                    <h4 className="font-bold text-sm uppercase tracking-widest text-foreground">Email Digests</h4>
                ...
                <TabsContent value="security" className="space-y-8">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <Card className="bg-surface backdrop-blur-3xl border-border rounded-[2.5rem] overflow-hidden">
                            <CardContent className="p-8 space-y-8">
                                <div className="space-y-4">
                                    <h4 className="font-bold text-sm uppercase tracking-widest text-foreground flex items-center gap-2">
                                        <Shield className="w-4 h-4 text-primary" />
                                        Login Security
                                    </h4>
                                    <div className="flex items-center justify-between">
                                        <div className="space-y-1">
                                            <p className="text-xs text-foreground font-bold">Two-Factor Authentication</p>
                                    ...
                                    <div className="flex items-center justify-between">
                                        <div className="space-y-1">
                                            <p className="text-xs text-foreground font-bold">Email Notifications</p>
                                            <p className="text-[10px] text-muted-foreground">Alert me of new logins</p>
                                        </div>
                                        <Switch defaultChecked />
                                    </div>
                                </div>
                                <Button className="w-full h-12 bg-background border border-border hover:bg-background font-bold uppercase tracking-widest text-[10px] rounded-xl">CHANGE PASSWORD</Button>
                            </CardContent>
                        </Card>
                                ...
                                <div className="space-y-4">
                                    {[
                                        ...
                                        <div key={i} className="flex items-center justify-between p-4 bg-background rounded-2xl border border-border">
                                            ...
                                            {i > 0 && <Button variant="ghost" className="text-[10px] font-bold uppercase text-primary hover:bg-primary/10 rounded-lg">Revoke</Button>}
                                        </div>
                                    ))}
                                </div>
                            </CardContent>
                ...
                <TabsContent value="account" className="space-y-8">
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                        <div className="lg:col-span-8 space-y-8">
                                ...
                                <CardContent className="p-8 space-y-8">
                                    <div className="flex items-center justify-between group cursor-pointer" onClick={() => setActiveTab('privacy')}>
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div className="space-y-1">
                                                <h4 className="font-bold text-sm uppercase tracking-widest text-foreground">Search Visibility</h4>
                                    ...
                                    <div className="flex items-center justify-between group cursor-pointer">
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div className="space-y-1">
                                                <h4 className="font-bold text-sm uppercase tracking-widest text-foreground">Communication Rules</h4>
                            ...
                            <Card className="bg-error/10 border border-error/25 rounded-[2rem] overflow-hidden">
                                <CardContent className="p-10 space-y-6">
                                    <div className="flex flex-col md:flex-row items-center justify-between gap-8">
                                        <div className="flex items-center gap-6">
                                            <div className="w-16 h-16 bg-error/10 rounded-[1.5rem] flex items-center justify-center animate-pulse">
                                                <AlertTriangle className="w-8 h-8 text-error" />
                                            </div>
                                            <div className="space-y-1">
                                                <h4 className="font-bold text-lg uppercase tracking-widest text-error">Danger Zone</h4>
                                        ...
                                        <Button 
                                            ...
                                            className="bg-error/10 hover:bg-error/10 text-error font-bold text-xs uppercase tracking-[0.2em] px-8 h-12 rounded-xl border border-error/25"
                                        >
                                            DELETE ACCOUNT
                                        </Button>
                                    </div>
                                    ...
                                    {showDeleteConfirm && (
                                        <motion.div 
                                            ...
                                            className="border-t border-error/25 pt-6 space-y-4"
                                        >
                                            <p className="text-sm text-error font-bold">⚠️ This action is irreversible. All your data, matches, messages, and photos will be permanently deleted.</p>
                                            <div className="flex items-center gap-4">
                                                <input
                                                    type="text"
                                                    ...
                                                    className="flex-1 h-12 px-4 bg-error/10 border border-error/25 rounded-xl text-sm font-bold text-error placeholder:text-error focus:outline-none focus:ring-2 focus:ring-red-500/30"
                                                />
                                                <Button
                                                    onClick={handleDeleteAccount}
                                                    disabled={deleteConfirmText !== 'DELETE' || isDeleting}
                                                    className="h-12 px-8 bg-error/10 hover:bg-error/10 text-foreground font-bold text-xs uppercase tracking-widest rounded-xl disabled:opacity-30"
                                                >
                        ...
                        <div className="lg:col-span-4 space-y-6">
                            <Card className="bg-primary/10 border-primary/20 rounded-[2rem] overflow-hidden text-center p-8">
                                <h4 className="font-bold text-sm uppercase tracking-widest text-primary mb-4">Premium Support</h4>
                                ...
                                <Button className="w-full bg-primary text-white font-bold text-xs uppercase tracking-[0.2em] rounded-xl h-12 shadow-lg shadow-primary/20">
                                    UPGRADE NOW
                                </Button>
                            </Card>

                            <div className="text-center space-y-2">
                                <p className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground">App Version v1.0.1 Stable</p>
                                <p className="text-[10px] font-bold text-primary font-medium uppercase tracking-widest">Built with love in Chhattisgarh</p>
                            </div>
                        </div>
                    </div>
                </TabsContent>
