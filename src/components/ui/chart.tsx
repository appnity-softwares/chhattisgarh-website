  ...
  return (
    <ChartContext.Provider value={{ config }}>
      ...
      >
        ...
        <RechartsPrimitive.ResponsiveContainer width="100%" height="100%" minWidth={100} minHeight={240} debounce={100}>
          {children}
...
>(
  (props, ref) => {
    const {
      ...
      formatter?: (value: number | string, name: string, item: ChartPayload, index: number, payload: Record<string, unknown>) => React.ReactNode
      color?: string
      nameKey?: string
      labelKey?: string
    }
