        ...
        <div className="relative h-[90vh] min-h-[600px] w-full flex items-center justify-center overflow-hidden">
            ...
            <div className="relative z-10 container mx-auto px-4 flex flex-col items-center text-center h-full justify-center">
                ...
                <div className="max-w-5xl mx-auto mb-12 animate-fade-in-up">
                    <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-black text-white mb-8 drop-shadow-2xl font-headline tracking-tight leading-tight">
                    ...
                    <p className="text-lg md:text-2xl text-gray-100 mb-12 max-w-3xl mx-auto drop-shadow-lg font-light leading-relaxed">
                        Thousands of verified profiles from your community. <br /> Trusted by families across the state.
                    </p>

                    <div className="flex flex-col items-center gap-6 transform hover:scale-105 transition-transform duration-300">
                        <div className="scale-110 md:scale-125 p-4 bg-white/10 backdrop-blur-sm rounded-3xl border border-white/20 shadow-2xl">
                            <AppStoreBadges />
                        </div>
                        <p className="text-xs md:text-sm text-gray-300 uppercase tracking-[0.2em] font-medium animate-pulse">
